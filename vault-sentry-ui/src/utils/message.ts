...
/** 封装提示信息，默认info */
export function Msg(message: any, plain = true, duration = 2000, type: MessageType = 'info', parseHtml = false) {
  ElMessage.closeAll();
  ElMessage({
    message,
    plain,
...
/** 封装提示信息，默认info */
export function MsgInfo(message: any, plain = true, duration = 2000, type: MessageType = 'info', parseHtml = false) {
  ElMessage.closeAll();
  ElMessage({
    message,
    plain,

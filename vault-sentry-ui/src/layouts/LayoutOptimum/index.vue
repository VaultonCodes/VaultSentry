...
const initMenu = () => {
  ...
  if (activeMenu) {
    ...
    if (topLevelMenu) {
      ...
      MsgError('The menu data configuration is error');
    }
  }
};
    ...
    >
      ...
      <ElScrollbar class="layout-scrollbar">
        <ElMenu
          ...
          :class="menuAnimate"
        >
          <ColumnSubMenu :menu-list="currentSubMenuTree"></ColumnSubMenu>
        </ElMenu>
      </ElScrollbar>
    </ElAside>
    <ElContainer>
        ...
        <div class="vault-header">
          <div class="header-left" :style="{ paddingRight: toolbarWidth + 16 + 'px' }">
            ...
            <div class="layout-row m-l-12px">
              <ElScrollbar ref="horizontalScrollbarRef" class="horizontal-scrollbar">
          ...
          <!-- 工具栏 -->
          <Toolbar @width-change="handleToolbarWidthChange"></Toolbar>
        </div>
      </ElHeader>
      <!-- 路由页面 -->
      <Main></Main>
...
.layout-row {
  ...
  &::after {
    ...
    background: linear-gradient(
      270deg,
      var(--el-header-bg-color) 0%,
      var(--el-header-optimum-mark-color) 50%,
      transparent 100%
    );
  }

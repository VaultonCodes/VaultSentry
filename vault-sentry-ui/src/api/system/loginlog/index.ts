...
// 统一管理接口
enum API {
  LIST_PAGE = '/api/sysLoginLog/listPage',
  GET_BY_ID = '/api/sysLoginLog/getById',
  UPDATE = '/api/sysLoginLog/update',
  ADD = '/api/sysLoginLog/add',
  DELETE = '/api/sysLoginLog/deleteById',
  BATCH_DELETE = '/api/sysLoginLog/batchDelete',
  UPDATE_STATUS = '/api/sysLoginLog/updateStatus'
}

...
import { add, batchDelete, deleteById, getById, listPage, update, updateStatus } from '@/api/system/dict/type/index.ts';
import {
  MsgBox,
  MsgError,
  MsgInfo,
  ...
  <div class="vault-flex">
    <VaultCard>
      ...
      <ElForm v-show="showSearch" :inline="true">
        ...
        <ElFormItem label="字典编号" prop="dictType">
          <ElInput
      ...
      <ElRow :gutter="10">
        ...
        <ElCol v-auth="['system:role:update']" :span="1.5">
          <ElButton type="danger" icon="Refresh" plain>刷新缓存</ElButton>
        </ElCol>
      ...
      >
        ...
        <ElTableColumn label="字典名称" prop="dictName" width="120px" align="center"></ElTableColumn>
        <ElTableColumn label="字典类型" prop="dictType" width="180px" align="center">
          ...
          <ElForm ref="formRef" :rules="rules" :model="form" label-width="80px" status-icon>
            <ElRow>
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="字典名称" prop="dictName">
                  <ElInput v-model="form.dictName" placeholder="请输入字典名称" clearable />
                </ElFormItem>
              </ElCol>
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="字典类型" prop="dictType">
                  <ElInput v-model="form.dictType" placeholder="请输入字典类型" clearable />
                </ElFormItem>
              </ElCol>
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="字典状态" prop="dictStatus">
                  <ElSelect v-model="form.dictStatus" placeholder="请选择字典状态" clearable>
                    <ElOption label="启用" value="1" />
                    <ElOption label="停用" value="0" />
                  </ElSelect>
                </ElFormItem>
              ...
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="字典备注" prop="remark">
                  <ElInput v-model="form.remark" :rows="5" type="textarea" placeholder="请输入字典备注" />
                </ElFormItem>
              </ElCol>
            </ElRow>
          </ElForm>

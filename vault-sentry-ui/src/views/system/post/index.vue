...
import { add, batchDelete, deleteById, getById, listPage, update, updateStatus } from '@/api/system/post/index.ts';
import {
  koiMsgBox,
  koiMsgError,
  koiMsgInfo,
...
const handleSwitch = (row: any) => {
  const text = row.postStatus === '1' ? '启用' : '停用';
  ...
  <div class="koi-flex">
    <VaultCard>
      ...
      <ElForm v-show="showSearch" :inline="true">
        ...
        <ElFormItem label="岗位状态" prop="postStatus">
          <ElSelect
      ...
      <ElRow :gutter="10">
        ...
        <VaultToolbar v-model:show-search="showSearch" @refresh-table="handleListPage"></KoiToolbar>
      </ElRow>
      ...
      >
        ...
        <ElTableColumn label="序号" prop="postId" width="80px" align="center" type="index"></ElTableColumn>
        <ElTableColumn
          label="岗位名称"
          prop="postName"
          width="180px"
        ...
        <ElTableColumn label="岗位状态" prop="postStatus" width="100px" align="center">
        ...
        <ElTableColumn label="创建人" prop="createBy" width="150px" align="center"></ElTableColumn>
        <ElTableColumn label="修改人" prop="updateBy" width="150px" align="center"></ElTableColumn>
        <ElTableColumn label="修改时间" prop="updateTime" width="180px" align="center"></ElTableColumn>
          ...
          <ElForm ref="formRef" :rules="rules" :model="form" label-width="80px" status-icon>
            <ElRow>
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="岗位名称" prop="postName">
                  <ElInput v-model="form.postName" placeholder="请输入岗位名称" clearable />
                </ElFormItem>
              </ElCol>
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="岗位编码" prop="postCode">
                  <ElInput v-model="form.postCode" placeholder="请输入岗位编码" clearable />
                </ElFormItem>
              </ElCol>
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="岗位状态" prop="postStatus">
                  <ElSelect v-model="form.postStatus" placeholder="请选择岗位状态" clearable>
                    <ElOption label="启用" value="1" />
                    <ElOption label="停用" value="0" />
                  </ElSelect>
                </ElFormItem>
              ...
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="排序" prop="sorted">
                  <ElInputNumber v-model="form.sorted" :min="0" :step="1" placeholder="请输入数字"></ElInputNumber>
                </ElFormItem>
              </ElCol>
              <ElCol :sm="{ span: 24 }" :xs="{ span: 24 }">
                <ElFormItem label="岗位备注" prop="remark">
                  <ElInput v-model="form.remark" :rows="5" type="textarea" placeholder="请输入岗位备注" />
                </ElFormItem>
              </ElCol>
            </ElRow>
          </ElForm>

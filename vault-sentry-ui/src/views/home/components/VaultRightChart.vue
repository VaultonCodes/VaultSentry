...
const handleData = () => {
  setTimeout(() => {
    const num1 = randomInt(500, 800);
    const num2 = randomInt(500, 800);
    const num3 = randomInt(500, 800);
    const num4 = randomInt(500, 800);
    const num5 = randomInt(600, 900);
    const num6 = randomInt(600, 900);
    const num7 = randomInt(600, 900);
    const num8 = randomInt(600, 900);
    const num9 = randomInt(500, 1000);
    const num10 = randomInt(500, 1000);
    xChartData.value = [
      '20250901',
      '20250902',
      '20250903',
...
<template>
  <div ref="refChart" v-loading="dataLoading" class="h-350px w-full"></div>
</template>

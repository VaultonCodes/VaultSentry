...
<template>
  <div v-loading="dataLoading" class="h-370px flex flex-col">
    <div class="flex flex-justify-center">
      <ElSegmented v-model="selectValue" :options="segmentedOptions" @change="handleData" />
    </div>
    <div ref="refChart" class="h-full w-full"></div>
  </div>
</template>

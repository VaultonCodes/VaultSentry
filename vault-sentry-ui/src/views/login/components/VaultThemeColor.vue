...
<template>
  <div class="vault-theme-color-picker">
    <!-- 颜色选择器触发按钮 -->
    <ElPopover placement="bottom" :width="280" trigger="hover" :offset="8" popper-class="theme-color-popover">
      <template #reference>
        <div class="theme-color-trigger">
          <ElIcon :size="20" class="trigger-icon">
            <Brush />
          </ElIcon>
        </div>
      </template>
